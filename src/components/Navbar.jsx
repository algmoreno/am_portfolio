...
const Navbar = () => {
  ...
  return (
    <nav className={`w-full flex items-center pt-5 pb-5 pl-1 pr-1 fixed top-0 z-20 bg-primary/60 backdrop-blur-lg backdrop-brightness-10 shadow-lg shadow-primary/80`}>
